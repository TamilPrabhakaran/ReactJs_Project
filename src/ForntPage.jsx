    ...
    <div className=' container  w-100 bg-dange'>
      ...
      <Card.Body className='position-absolute '>
        ...
        <span style={{color:'#02060c', opacity:'60.0%', fontWeight:'400'}}>Ice Cream, Desserts</span> <br /> <span style={{color:'#02060c', opacity:'60.0%', fontWeight:'400'}}>KK Nagar</span>
            ...
            <Link to='' style={{textDecoration:'none'}}>
      <Card style={{background:'white', borderColor:'white'}}>
      <Card.Img variant="top" src="/images/asset 24.jpeg" className='position-relative' style={{maxHeight:'200px', borderRadius:'20px'}} />
      <Card.Body className='position-absolute '>
        <Card.Title className='card-detail'>50% OFF UPTO &#8377;100 </Card.Title>
      </Card.Body>

        <Card.Text className='bg-warnin pt-2 px-3 '>
        <span style={{fontSize:'1.2rem', color:'02060c', fontWeight:'bold'}}>Burger King</span>
        <br />
        <img src="./images/star.png" alt="" width={20} height={20} className="d-inline-block"/> <span style={{color:'212529', fontWeight:'bold'}}>4.4 |25-30 mins</span> <br />

        <span style={{color:'#02060c', opacity:'60.0%', fontWeight:'400'}}>Burger, American</span> <br /> <span style={{color:'#02060c', opacity:'60.0%', fontWeight:'400'}}>KK Nagar</span>
        </Card.Text>
    </Card>
    </Link>
            </div>
            ...
            <Link to='' style={{textDecoration:'none'}}>
      <Card style={{background:'white', borderColor:'white'}}>
      <Card.Img variant="top" src="/images/asset 26.jpeg" className='position-relative' style={{maxHeight:'200px', borderRadius:'20px'}} />
      <Card.Body className='position-absolute '>
        <Card.Title className='card-detail'>20% OFF UPTO &#8377;50 </Card.Title>
      </Card.Body>
        ...
        <div className='bg-dange container '>
            ...
            <Link to='' style={{textDecoration:'none'}}>
      <Card style={{background:'white', borderColor:'white'}}>
      <Card.Img variant="top" src="/images/asset 25.jpeg" className='position-relative card-image' style={{maxHeight:'200px', borderRadius:'20px'}} />
      <Card.Body className='position-absolute '>
        <Card.Title className='card-detail'>ITEMS AT &#8377;169 </Card.Title>
      </Card.Body>

        <Card.Text className='bg-warnin pt-2 px-3 '>
        <span style={{fontSize:'1.2rem', color:'02060c', fontWeight:'bold'}}>Big Bowl</span>
        <br />
        <img src="./images/star.png" alt="" width={20} height={20} className="d-inline-block"/> <span style={{color:'212529', fontWeight:'bold'}}>3.9 |20-25 mins</span> <br />
        ...
        <span style={{color:'#02060c', opacity:'60.0%', fontWeight:'400'}}>Anna Nagar</span> 
            ...
            <Link to='' style={{textDecoration:'none'}}>
      <Card style={{background:'white', borderColor:'white'}}>
      <Card.Img variant="top" src="/images/asset 27.jpeg" className='position-relative' style={{maxHeight:'200px', borderRadius:'20px'}} />
      <Card.Body className='position-absolute '>
        <Card.Title className='card-detail'>20% OFF UPTO &#8377;50 </Card.Title>
      </Card.Body>

        <Card.Text className='bg-warnin pt-2 px-3 '>
        <span style={{fontSize:'1.2rem', color:'02060c', fontWeight:'bold'}}>McDonlad's</span>
        <br />
        <img src="./images/star.png" alt="" width={20} height={20} className="d-inline-block"/> <span style={{color:'212529', fontWeight:'bold'}}>4.3 |20-25 mins</span> <br />

        <span style={{color:'#02060c', opacity:'60.0%', fontWeight:'400'}}>Burger, Beverages, Cafe, Desserts</span> <br /> <span style={{color:'#02060c', opacity:'60.0%', fontWeight:'400'}}>KK Nagar</span>
        </Card.Text>
    </Card>
    </Link>
            </div>
      ...
      <Card.Body className='position-absolute '>
        ...
        <Card.Text className='bg-warnin pt-2 px-3 '>
        <span style={{fontSize:'1.2rem', color:'02060c', fontWeight:'bold'}}>UBQ by Barbrque Nation</span>
        <br />
        <img src="./images/star.png" alt="" width={20} height={20} className="d-inline-block"/> <span style={{color:'212529', fontWeight:'bold'}}>3.9 |35-40 mins</span> <br />

        <span style={{color:'#02060c', opacity:'60.0%', fontWeight:'400'}}>North Indian, Barbeque, Biryani</span> <br /> <span style={{color:'#02060c', opacity:'60.0%', fontWeight:'400'}}>Thappakulam</span>
        </Card.Text>
    </Card>
    </Link>
            </div>
            ...
            <Link to='' style={{textDecoration:'none'}}>
      <Card style={{background:'white', borderColor:'white'}}>
      <Card.Img variant="top" src="/images/asset 28.jpeg" className='position-relative' style={{maxHeight:'200px', borderRadius:'20px'}} />
      <Card.Body className='position-absolute '>
        <Card.Title className='card-detail'>50% OFF UPTO &#8377;100 </Card.Title>
      </Card.Body>
...
<div className=' overflow-x-scroll w-100  design '>
      ...
      <div className='container bg-succes '> <h4 className='fw-bold '>Best Place to Eat Across Cities</h4>  </div> <br />
      <div className=' container  w-100 bg-dange '>
      ...
      <div className=' container  w-100 bg-dange'>
        <ul className='list-text2 d-flex  gap-3  overflow-hidde overflow-x-scrol  scroll-lin' >
          ...
          <li className='target-list2 p-1'>South Indian Restaurants Near Me</li>
      ...
      <div className=' container  w-100 bg-dange'>
        <ul className='list-text2 d-flex  gap-3  overflow-hidde overflow-x-scrol  scroll-lin' >
          ...
          <li className='target-list2 p-1'>North Indian Restaurants Near Me</li>
      ...
      <div className=' container  w-100 bg-dange '>
        ...
        <div className='target-list3 p-3 m-2 '> Explore Top Rated Restaurants Near Me</div>
      </div>
    ...
    <div className=' container  w-100 bg-dange d-flex justify-content-around row  '>
      <div className='target-lis col d-none d-lg-block '><h2 className='fw-bold text-secondary' >For Favorite Better Experience, download the Paradie's app now</h2></div>
      <div className='target-lis col  d-flex   '> 
      <img src="./images/asset 41.png" alt="" width={200} height={70} className='d-inline-block'/> 
      <img src="./images/asset 42.png" alt="" width={200} height={70} className='d-inline-block'/>
      </div>
    </div>
    </div>
    </div>   <br /> <br />
